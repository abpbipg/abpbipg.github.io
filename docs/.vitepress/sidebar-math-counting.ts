  ...
  '/net/math-counting/': [
    {
      ...
      items: [
        ...
        // PDF
        { text: '路由协议基础（PDF）', link: '/net/math-counting/files/路由协议基础.pdf' },
...

        {
          ...
          items: [
            ...
            { text: 'Super VLAN', link: '/net/math-counting/files/vlan高级技术/Super_Vlan' },
        ...
        // 你 files 根目录里还有 PPP / 组播 / PIM / IGMP 等，放这里方便找
        {
          text: 'PPP / 组播',
          items: [
        ...
        // 这些在你的 index.md 里也有
        { text: '葵花宝典', link: '/net/math-counting/葵花宝典/葵花宝典' },
        { text: 'OSPF 知识重梳理', link: '/net/math-counting/OSPF/OSPF' },

        // STP 在 “软件定义网络” 目录下
        { text: 'STP', link: '/net/math-counting/软件定义网络/STP' },
      ],
    },

    {
      text: 'BGP / MPLS / VPN / SR / IPv6',
      items: [
        {
          text: 'BGP',
          items: [
            ...
            { text: 'BGP选路规则专题（PDF）', link: '/net/math-counting/files/BGP/BGP选路规则专题(V1.0).pdf' },
            { text: 'BGP EVPN / MP-BGP', link: '/net/math-counting/files/EVPN.MP-BGP' },
          ],
        },

        {
          ...
          items: [
            ...
            { text: 'MPLS LDP', link: '/net/math-counting/files/MPLS/MPLS_LDP' },
            { text: 'MPLS 路由迭代问题', link: '/net/math-counting/files/MPLS/MPLS_路由迭代问题' },
          ],
        },

        {
          text: 'VPN',
          items: [
            { text: 'MPLS VPN', link: '/net/math-counting/files/MPLS_VPN/MPLS_VPN' },
            { text: 'MPLS vpn应用场景', link: '/net/math-counting/files/MPLS_VPN/MPLSvpn应用场景' },
          ],
        },

        { text: 'SR：Segment Routing 段路由', link: '/net/math-counting/files/SR/Segment_Routing_段路由' },
      ...
      items: [
...

        {
          ...
          items: [
            ...
            { text: '路由器QoS专题(V4.0)（PDF）', link: '/net/math-counting/files/IE/QOS/路由器QoS专题(V4.0).pdf' },
          ],
        },

        { text: '以太网安全（IE）', link: '/net/math-counting/files/IE/以太网安全/以太网安全' },

        {
          text: '防火墙（IE）',
          items: [
            { text: '防火墙', link: '/net/math-counting/files/IE/防火墙/防火墙' },
            { text: '双机热备份', link: '/net/math-counting/files/IE/防火墙/双机热备份' },
            { text: '强叔侃墙1（PDF）', link: '/net/math-counting/files/IE/防火墙/强叔侃墙1.pdf' },
            { text: '强叔侃墙2（PDF）', link: '/net/math-counting/files/IE/防火墙/强叔侃墙2.pdf' },
            { text: '强叔侃墙03（PDF）', link: '/net/math-counting/files/IE/防火墙/强叔侃墙03.pdf' },
          ],
        },

        { text: 'MPLS VPN 跨域', link: '/net/math-counting/files/IE/MPLS_VPN跨域/MPLS_VPN跨域' },
        ...
        { text: 'EVPN / VPLS', link: '/net/math-counting/files/IE/EVPN/evpn' },
        { text: 'VXLAN', link: '/net/math-counting/files/IE/VXLAN/VXLAN' },

        { text: '网络准入规则', link: '/net/math-counting/files/IE/网络准入规则/网络准入规则' },
        { text: '业务随行', link: '/net/math-counting/files/IE/业务随行/业务随行' },
        { text: '广域网技术', link: '/net/math-counting/files/IE/广域网技术/广域网技术' },

        {
          text: 'SD-WAN',
          items: [
            { text: 'SD-WAN', link: '/net/math-counting/files/IE/SD-WAN/SD-WAN' },
            { text: 'SD-WAN 方案与规划设计（PPTX）', link: '/net/math-counting/files/IE/SD-WAN/27%20SD-WAN解决方案与规划设计.pptx' },
          ],
        },

        { text: 'RESTful', link: '/net/math-counting/files/IE/RESTful/RESTful' },

        { text: 'SR（IE）', link: '/net/math-counting/files/IE/SR/SR' },
        { text: 'SRV6', link: '/net/math-counting/files/IE/SR/SRv6' },

        { text: '网络编程与自动化', link: '/net/math-counting/files/IE/网络编程与自动化/网络编程与自动化' },
        { text: '企业广域承载网设计', link: '/net/math-counting/files/IE/企业广域承载网设计/企业广域承载网设计' },
...

    {
      text: '问题（外链）',
      items: [
        { text: 'S3700等交换机案例库', link: 'https://support.huawei.com/enterprise/zh/knowledge/s3700-s5700-s6700-vid-259602657' },
        { text: 'OSPF邻居full,无法正常从邻居学习路由', link: 'https://support.huawei.com/enterprise/zh/knowledge/EKB1100048492' },
      ],
    },
  ],
}